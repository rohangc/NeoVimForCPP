    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>fo', require('telescope.builtin').lsp_incoming_calls, 'Telescope [O]utgoing calls')
          ...
          map('<leader>fw', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Telescope [W]orkspace symbols')
          ...
          map('<leader><F3>', vim.lsp.buf.code_action, '[C]ode [A]ction', { 'n', 'x' })
      ...
      require('mason-lspconfig').setup {
        ...
        handlers = {
          function(server_name)
            ...
            -- Remove the following line once this issue is fixed: https://github.com/neovim/nvim-lspconfig/issues/3494
